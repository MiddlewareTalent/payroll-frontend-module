...
return (
      <div className="p45-container">
          ...
          <div className="form-label"style={{ left: `${convert(167)}`, top: `${convert(8.25)}` }}>P45 Part 1A</div>
  ...
  <div type="text" className="date" style={{ left: `${convert(35.5)}`, top: `${convert(231.055)}`, position:'absolute' }}>{p45.employeeDateOfBirth[1]}</div>
  ...
  <div type="text" className="employer-address-box" style={{ left: convert(116.5), top: convert(200.347), position: 'absolute' }}><p>{p45.companyName}{p45.companyAddress}</p></div>
  ...
  <div type="text" className="date" style={{ left: `${convert(130)}`, top: `${convert(243.755)}`, position:'absolute' }}>{p45.p45Date[1]}</div>
  
  <div type="text" className="year" style={{ left: `${convert(143.5)}`, top: `${convert(243.755)}`, position:'absolute' }}>{p45.p45Date[0]}</div>

  <div
  style={{position: 'absolute',left: convert(13),top: convert(251.6),}}><h2 >To the employee </h2><p style={{lineHeight:'17.3px'}} > 
...
<div
  style={{position: 'absolute',left: convert(107.48),top: convert(251.6),}}><h2 style={{fontSize:'12px'}}>Tax credits and Universal Credit </h2><p style={{lineHeight:'17.3px'}}> 
    ...
    change in your income, phone <span style={{fontWeight:'bold'}}>0345 300 3900</span>
  </p>
</div>

<div
  style={{position: 'absolute',left: convert(107.48),top: convert(270.5),}}><h2 >To the new employer </h2><p style={{lineHeight:'17.3px'}}> 
